...
if {[file isfile standalone_mmult.autotvin.dat]} {
	file delete -force standalone_mmult.autotvin.dat
}

if {[file isfile standalone_mmult.autotvout.dat]} {
	file delete -force standalone_mmult.autotvout.dat
}
