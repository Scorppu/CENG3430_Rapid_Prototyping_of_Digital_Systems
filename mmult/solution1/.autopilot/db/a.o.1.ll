; ModuleID = 'C:/Users/Student/mmult/solution1/.autopilot/db/a.g.1.bc'
target datalayout = "e-p:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-f80:128:128-v64:64:64-v128:128:128-a0:0:64-f80:32:32-n8:16:32-S32"
target triple = "i686-pc-mingw32"

%struct.ap_axiu.40 = type { %struct.ap_uint.30, %struct.ap_uint.0.33, %struct.ap_uint.0.33, %struct.ap_uint.0.33, %struct.ap_uint.3.36, %struct.ap_uint.6.39, %struct.ap_uint.6.39 }
...
%struct.ssdm_int.2.31 = type { i4 }
%struct.ap_uint.3.36 = type { %struct.ap_int_base.4.35 }
%struct.ap_int_base.4.35 = type { %struct.ssdm_int.5.34 }
%struct.ssdm_int.5.34 = type { i1 }
%struct.ap_uint.6.39 = type { %struct.ap_int_base.7.38 }
%struct.ap_int_base.7.38 = type { %struct.ssdm_int.8.37 }
%struct.ssdm_int.8.37 = type { i5 }
...
; [#uses=0]
define void @HLS_accel(%struct.ap_axiu.40* %INPUT_STREAM, %struct.ap_axiu.40* %OUTPUT_STREAM) nounwind {
  %a = alloca [32 x [32 x float]], align 4        ; [#uses=3 type=[32 x [32 x float]]*]
  %b = alloca [32 x [32 x float]], align 4        ; [#uses=3 type=[32 x [32 x float]]*]
  ...
  call void @llvm.dbg.value(metadata !{%struct.ap_axiu.40* %INPUT_STREAM}, i64 0, metadata !4392), !dbg !4393 ; [debug line = 20:25] [debug variable = INPUT_STREAM]
  call void @llvm.dbg.value(metadata !{%struct.ap_axiu.40* %OUTPUT_STREAM}, i64 0, metadata !4394), !dbg !4395 ; [debug line = 20:55] [debug variable = OUTPUT_STREAM]
  call void (...)* @_ssdm_SpecArrayDimSize(%struct.ap_axiu.40* %OUTPUT_STREAM, i32 1024) nounwind, !dbg !4396 ; [debug line = 21:2]
  call void (...)* @_ssdm_SpecArrayDimSize(%struct.ap_axiu.40* %INPUT_STREAM, i32 2048) nounwind, !dbg !4398 ; [debug line = 21:45]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, i8* getelementptr inbounds ([10 x i8]* @.str, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([12 x i8]* @.str2, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !4399 ; [debug line = 23:1]
  call void (...)* @_ssdm_op_SpecInterface(%struct.ap_axiu.40* %INPUT_STREAM, i8* getelementptr inbounds ([5 x i8]* @.str3, i32 0, i32 0), i32 1, i32 1, i8* getelementptr inbounds ([5 x i8]* @.str4, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !4400 ; [debug line = 24:1]
  call void (...)* @_ssdm_op_SpecInterface(%struct.ap_axiu.40* %OUTPUT_STREAM, i8* getelementptr inbounds ([5 x i8]* @.str3, i32 0, i32 0), i32 1, i32 1, i8* getelementptr inbounds ([5 x i8]* @.str4, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !4401 ; [debug line = 25:1]
  call void @llvm.dbg.value(metadata !{%struct.ap_axiu.40* %INPUT_STREAM}, i64 0, metadata !4402) nounwind, !dbg !4404 ; [debug line = 124:10@27:2] [debug variable = in_stream]
  call void @llvm.dbg.value(metadata !{%struct.ap_axiu.40* %OUTPUT_STREAM}, i64 0, metadata !4405) nounwind, !dbg !4406 ; [debug line = 125:10@27:2] [debug variable = out_stream]
  call void @llvm.dbg.declare(metadata !{[32 x [32 x float]]* %a}, metadata !4407) nounwind, !dbg !4411 ; [debug line = 130:4@27:2] [debug variable = a]
  call void @llvm.dbg.declare(metadata !{[32 x [32 x float]]* %b}, metadata !4412) nounwind, !dbg !4413 ; [debug line = 131:4@27:2] [debug variable = b]
  call void @llvm.dbg.declare(metadata !{[32 x [32 x float]]* %out}, metadata !4414) nounwind, !dbg !4415 ; [debug line = 132:4@27:2] [debug variable = out]
  br label %1, !dbg !4416                         ; [debug line = 137:13@27:2]

; <label>:1                                       ; preds = %3, %0
  %i.0.i = phi i32 [ 0, %0 ], [ %i, %3 ]          ; [#uses=4 type=i32]
  %exitcond5.i = icmp eq i32 %i.0.i, 32, !dbg !4416 ; [#uses=1 type=i1] [debug line = 137:13@27:2]
  br i1 %exitcond5.i, label %.preheader7.i.preheader, label %.preheader8.preheader.i, !dbg !4416 ; [debug line = 137:13@27:2]

.preheader7.i.preheader:                          ; preds = %1
  br label %.preheader7.i, !dbg !4418             ; [debug line = 147:14@27:2]

.preheader8.preheader.i:                          ; preds = %1
  %tmp = shl i32 %i.0.i, 5, !dbg !4420            ; [#uses=1 type=i32] [debug line = 141:17@27:2]
  br label %.preheader8.i, !dbg !4423             ; [debug line = 138:14@27:2]

.preheader8.i:                                    ; preds = %2, %.preheader8.preheader.i
  %j.0.i = phi i32 [ %j, %2 ], [ 0, %.preheader8.preheader.i ] ; [#uses=4 type=i32]
  %exitcond4.i = icmp eq i32 %j.0.i, 32, !dbg !4423 ; [#uses=1 type=i1] [debug line = 138:14@27:2]
  br i1 %exitcond4.i, label %3, label %2, !dbg !4423 ; [debug line = 138:14@27:2]

; <label>:2                                       ; preds = %.preheader8.i
  %rbegin11.i = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str5, i32 0, i32 0)) nounwind, !dbg !4424 ; [#uses=1 type=i32] [debug line = 139:4@27:2]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !4425 ; [debug line = 140:1@27:2]
  %k = add nsw i32 %j.0.i, %tmp, !dbg !4420       ; [#uses=7 type=i32] [debug line = 141:17@27:2]
  call void @llvm.dbg.value(metadata !{i32 %k}, i64 0, metadata !4426) nounwind, !dbg !4420 ; [debug line = 141:17@27:2] [debug variable = k]
  %INPUT_STREAM.addr = getelementptr inbounds %struct.ap_axiu.40* %INPUT_STREAM, i32 %k, i32 0, i32 0, i32 0, i32 0, !dbg !4427 ; [#uses=1 type=i32*] [debug line = 1653:70@82:19@142:14@27:2]
  %INPUT_STREAM.load = load i32* %INPUT_STREAM.addr, align 4, !dbg !4427 ; [#uses=2 type=i32] [debug line = 1653:70@82:19@142:14@27:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %INPUT_STREAM.load) nounwind
  %ret = bitcast i32 %INPUT_STREAM.load to float, !dbg !4432 ; [#uses=1 type=float] [debug line = 83:24@142:14@27:2]
  call void @llvm.dbg.value(metadata !{float %ret}, i64 0, metadata !4433) nounwind, !dbg !4432 ; [debug line = 83:24@142:14@27:2] [debug variable = ret]
  %INPUT_STREAM.addr.1 = getelementptr inbounds %struct.ap_axiu.40* %INPUT_STREAM, i32 %k, i32 2, i32 0, i32 0, i32 0, !dbg !4434 ; [#uses=1 type=i4*] [debug line = 85:43@142:14@27:2]
  %INPUT_STREAM.load.1 = load i4* %INPUT_STREAM.addr.1, align 1, !dbg !4434 ; [#uses=1 type=i4] [debug line = 85:43@142:14@27:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i4 %INPUT_STREAM.load.1) nounwind
  %INPUT_STREAM.addr.2 = getelementptr inbounds %struct.ap_axiu.40* %INPUT_STREAM, i32 %k, i32 1, i32 0, i32 0, i32 0, !dbg !4435 ; [#uses=1 type=i4*] [debug line = 86:43@142:14@27:2]
  %INPUT_STREAM.load.2 = load i4* %INPUT_STREAM.addr.2, align 1, !dbg !4435 ; [#uses=1 type=i4] [debug line = 86:43@142:14@27:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i4 %INPUT_STREAM.load.2) nounwind
  %INPUT_STREAM.addr.3 = getelementptr inbounds %struct.ap_axiu.40* %INPUT_STREAM, i32 %k, i32 3, i32 0, i32 0, i32 0, !dbg !4436 ; [#uses=1 type=i4*] [debug line = 87:35@142:14@27:2]
  %INPUT_STREAM.load.3 = load i4* %INPUT_STREAM.addr.3, align 1, !dbg !4436 ; [#uses=1 type=i4] [debug line = 87:35@142:14@27:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i4 %INPUT_STREAM.load.3) nounwind
  %INPUT_STREAM.addr.4 = getelementptr inbounds %struct.ap_axiu.40* %INPUT_STREAM, i32 %k, i32 4, i32 0, i32 0, i32 0, !dbg !4437 ; [#uses=1 type=i1*] [debug line = 88:35@142:14@27:2]
  %INPUT_STREAM.load.4 = load i1* %INPUT_STREAM.addr.4, align 1, !dbg !4437 ; [#uses=1 type=i1] [debug line = 88:35@142:14@27:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %INPUT_STREAM.load.4) nounwind
  %INPUT_STREAM.addr.5 = getelementptr inbounds %struct.ap_axiu.40* %INPUT_STREAM, i32 %k, i32 5, i32 0, i32 0, i32 0, !dbg !4438 ; [#uses=1 type=i5*] [debug line = 89:32@142:14@27:2]
  %INPUT_STREAM.load.5 = load i5* %INPUT_STREAM.addr.5, align 1, !dbg !4438 ; [#uses=1 type=i5] [debug line = 89:32@142:14@27:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i5 %INPUT_STREAM.load.5) nounwind
  %INPUT_STREAM.addr.6 = getelementptr inbounds %struct.ap_axiu.40* %INPUT_STREAM, i32 %k, i32 6, i32 0, i32 0, i32 0, !dbg !4439 ; [#uses=1 type=i5*] [debug line = 90:36@142:14@27:2]
  %INPUT_STREAM.load.6 = load i5* %INPUT_STREAM.addr.6, align 1, !dbg !4439 ; [#uses=1 type=i5] [debug line = 90:36@142:14@27:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i5 %INPUT_STREAM.load.6) nounwind
  %a.addr = getelementptr inbounds [32 x [32 x float]]* %a, i32 0, i32 %i.0.i, i32 %j.0.i, !dbg !4431 ; [#uses=1 type=float*] [debug line = 142:14@27:2]
  store float %ret, float* %a.addr, align 4, !dbg !4431 ; [debug line = 142:14@27:2]
  %rend12.i = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str5, i32 0, i32 0), i32 %rbegin11.i) nounwind, !dbg !4440 ; [#uses=0 type=i32] [debug line = 144:3@27:2]
  %j = add nsw i32 %j.0.i, 1, !dbg !4441          ; [#uses=1 type=i32] [debug line = 138:23@27:2]
  call void @llvm.dbg.value(metadata !{i32 %j}, i64 0, metadata !4442) nounwind, !dbg !4441 ; [debug line = 138:23@27:2] [debug variable = j]
  br label %.preheader8.i, !dbg !4441             ; [debug line = 138:23@27:2]

; <label>:3                                       ; preds = %.preheader8.i
  %i = add nsw i32 %i.0.i, 1, !dbg !4443          ; [#uses=1 type=i32] [debug line = 137:22@27:2]
  call void @llvm.dbg.value(metadata !{i32 %i}, i64 0, metadata !4444) nounwind, !dbg !4443 ; [debug line = 137:22@27:2] [debug variable = i]
  br label %1, !dbg !4443                         ; [debug line = 137:22@27:2]

.preheader7.i:                                    ; preds = %5, %.preheader7.i.preheader
  %i1.0.i = phi i32 [ %i.1, %5 ], [ 0, %.preheader7.i.preheader ] ; [#uses=4 type=i32]
  %exitcond3.i = icmp eq i32 %i1.0.i, 32, !dbg !4418 ; [#uses=1 type=i1] [debug line = 147:14@27:2]
  br i1 %exitcond3.i, label %6, label %.preheader6.preheader.i, !dbg !4418 ; [debug line = 147:14@27:2]

.preheader6.preheader.i:                          ; preds = %.preheader7.i
  %tmp.1 = mul i32 %i1.0.i, 32, !dbg !4445        ; [#uses=1 type=i32] [debug line = 151:22@27:2]
  br label %.preheader6.i, !dbg !4448             ; [debug line = 148:15@27:2]

.preheader6.i:                                    ; preds = %4, %.preheader6.preheader.i
  %j2.0.i = phi i32 [ %j.1, %4 ], [ 0, %.preheader6.preheader.i ] ; [#uses=4 type=i32]
  %exitcond2.i = icmp eq i32 %j2.0.i, 32, !dbg !4448 ; [#uses=1 type=i1] [debug line = 148:15@27:2]
  br i1 %exitcond2.i, label %5, label %4, !dbg !4448 ; [debug line = 148:15@27:2]

; <label>:4                                       ; preds = %.preheader6.i
  %rbegin9.i = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str6, i32 0, i32 0)) nounwind, !dbg !4449 ; [#uses=1 type=i32] [debug line = 149:5@27:2]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !4450 ; [debug line = 150:1@27:2]
  %tmp.6 = add i32 %tmp.1, 1024, !dbg !4445       ; [#uses=1 type=i32] [debug line = 151:22@27:2]
  %k.1 = add i32 %tmp.6, %j2.0.i, !dbg !4445      ; [#uses=7 type=i32] [debug line = 151:22@27:2]
  call void @llvm.dbg.value(metadata !{i32 %k.1}, i64 0, metadata !4451) nounwind, !dbg !4445 ; [debug line = 151:22@27:2] [debug variable = k]
  %INPUT_STREAM.addr.7 = getelementptr inbounds %struct.ap_axiu.40* %INPUT_STREAM, i32 %k.1, i32 0, i32 0, i32 0, i32 0, !dbg !4452 ; [#uses=1 type=i32*] [debug line = 1653:70@82:19@152:15@27:2]
  %INPUT_STREAM.load.7 = load i32* %INPUT_STREAM.addr.7, align 4, !dbg !4452 ; [#uses=2 type=i32] [debug line = 1653:70@82:19@152:15@27:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %INPUT_STREAM.load.7) nounwind
  %ret.1 = bitcast i32 %INPUT_STREAM.load.7 to float, !dbg !4455 ; [#uses=1 type=float] [debug line = 83:24@152:15@27:2]
  call void @llvm.dbg.value(metadata !{float %ret.1}, i64 0, metadata !4456) nounwind, !dbg !4455 ; [debug line = 83:24@152:15@27:2] [debug variable = ret]
  %INPUT_STREAM.addr.8 = getelementptr inbounds %struct.ap_axiu.40* %INPUT_STREAM, i32 %k.1, i32 2, i32 0, i32 0, i32 0, !dbg !4457 ; [#uses=1 type=i4*] [debug line = 85:43@152:15@27:2]
  %INPUT_STREAM.load.8 = load i4* %INPUT_STREAM.addr.8, align 1, !dbg !4457 ; [#uses=1 type=i4] [debug line = 85:43@152:15@27:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i4 %INPUT_STREAM.load.8) nounwind
  %INPUT_STREAM.addr.9 = getelementptr inbounds %struct.ap_axiu.40* %INPUT_STREAM, i32 %k.1, i32 1, i32 0, i32 0, i32 0, !dbg !4458 ; [#uses=1 type=i4*] [debug line = 86:43@152:15@27:2]
  %INPUT_STREAM.load.9 = load i4* %INPUT_STREAM.addr.9, align 1, !dbg !4458 ; [#uses=1 type=i4] [debug line = 86:43@152:15@27:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i4 %INPUT_STREAM.load.9) nounwind
  %INPUT_STREAM.addr.10 = getelementptr inbounds %struct.ap_axiu.40* %INPUT_STREAM, i32 %k.1, i32 3, i32 0, i32 0, i32 0, !dbg !4459 ; [#uses=1 type=i4*] [debug line = 87:35@152:15@27:2]
  %INPUT_STREAM.load.10 = load i4* %INPUT_STREAM.addr.10, align 1, !dbg !4459 ; [#uses=1 type=i4] [debug line = 87:35@152:15@27:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i4 %INPUT_STREAM.load.10) nounwind
  %INPUT_STREAM.addr.11 = getelementptr inbounds %struct.ap_axiu.40* %INPUT_STREAM, i32 %k.1, i32 4, i32 0, i32 0, i32 0, !dbg !4460 ; [#uses=1 type=i1*] [debug line = 88:35@152:15@27:2]
  %INPUT_STREAM.load.11 = load i1* %INPUT_STREAM.addr.11, align 1, !dbg !4460 ; [#uses=1 type=i1] [debug line = 88:35@152:15@27:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %INPUT_STREAM.load.11) nounwind
  %INPUT_STREAM.addr.12 = getelementptr inbounds %struct.ap_axiu.40* %INPUT_STREAM, i32 %k.1, i32 5, i32 0, i32 0, i32 0, !dbg !4461 ; [#uses=1 type=i5*] [debug line = 89:32@152:15@27:2]
  %INPUT_STREAM.load.12 = load i5* %INPUT_STREAM.addr.12, align 1, !dbg !4461 ; [#uses=1 type=i5] [debug line = 89:32@152:15@27:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i5 %INPUT_STREAM.load.12) nounwind
  %INPUT_STREAM.addr.13 = getelementptr inbounds %struct.ap_axiu.40* %INPUT_STREAM, i32 %k.1, i32 6, i32 0, i32 0, i32 0, !dbg !4462 ; [#uses=1 type=i5*] [debug line = 90:36@152:15@27:2]
  %INPUT_STREAM.load.13 = load i5* %INPUT_STREAM.addr.13, align 1, !dbg !4462 ; [#uses=1 type=i5] [debug line = 90:36@152:15@27:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i5 %INPUT_STREAM.load.13) nounwind
  %b.addr = getelementptr inbounds [32 x [32 x float]]* %b, i32 0, i32 %i1.0.i, i32 %j2.0.i, !dbg !4454 ; [#uses=1 type=float*] [debug line = 152:15@27:2]
  store float %ret.1, float* %b.addr, align 4, !dbg !4454 ; [debug line = 152:15@27:2]
  %rend10.i = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str6, i32 0, i32 0), i32 %rbegin9.i) nounwind, !dbg !4463 ; [#uses=0 type=i32] [debug line = 153:4@27:2]
  %j.1 = add nsw i32 %j2.0.i, 1, !dbg !4464       ; [#uses=1 type=i32] [debug line = 148:24@27:2]
  call void @llvm.dbg.value(metadata !{i32 %j.1}, i64 0, metadata !4465) nounwind, !dbg !4464 ; [debug line = 148:24@27:2] [debug variable = j]
  br label %.preheader6.i, !dbg !4464             ; [debug line = 148:24@27:2]

; <label>:5                                       ; preds = %.preheader6.i
  %i.1 = add nsw i32 %i1.0.i, 1, !dbg !4466       ; [#uses=1 type=i32] [debug line = 147:23@27:2]
  call void @llvm.dbg.value(metadata !{i32 %i.1}, i64 0, metadata !4467) nounwind, !dbg !4466 ; [debug line = 147:23@27:2] [debug variable = i]
  br label %.preheader7.i, !dbg !4466             ; [debug line = 147:23@27:2]

; <label>:6                                       ; preds = %.preheader7.i
  %a.assign = getelementptr inbounds [32 x [32 x float]]* %a, i32 0, i32 0, !dbg !4468 ; [#uses=1 type=[32 x float]*] [debug line = 156:4@27:2]
  %b.assign = getelementptr inbounds [32 x [32 x float]]* %b, i32 0, i32 0, !dbg !4468 ; [#uses=1 type=[32 x float]*] [debug line = 156:4@27:2]
  call void @llvm.dbg.value(metadata !{[32 x float]* %a.assign}, i64 0, metadata !4469) nounwind, !dbg !4470 ; [debug line = 44:17@156:4@27:2] [debug variable = a]
  call void @llvm.dbg.value(metadata !{[32 x float]* %b.assign}, i64 0, metadata !4471) nounwind, !dbg !4472 ; [debug line = 44:32@156:4@27:2] [debug variable = b]
  call void (...)* @_ssdm_SpecArrayPartition([32 x float]* %a.assign, i32 2, i8* getelementptr inbounds ([6 x i8]* @.str8, i32 0, i32 0), i32 32, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !4473 ; [debug line = 47:1@156:4@27:2]
  call void (...)* @_ssdm_SpecArrayPartition([32 x float]* %b.assign, i32 1, i8* getelementptr inbounds ([6 x i8]* @.str8, i32 0, i32 0), i32 32, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !4475 ; [debug line = 48:1@156:4@27:2]
  br label %7, !dbg !4476                         ; [debug line = 51:20@156:4@27:2]

; <label>:7                                       ; preds = %14, %6
  %ia.0.i.i = phi i32 [ 0, %6 ], [ %ia, %14 ]     ; [#uses=4 type=i32]
  %exitcond2.i.i = icmp eq i32 %ia.0.i.i, 32, !dbg !4476 ; [#uses=1 type=i1] [debug line = 51:20@156:4@27:2]
  br i1 %exitcond2.i.i, label %"mmult_hw<float, 32>.exit.i.preheader", label %8, !dbg !4476 ; [debug line = 51:20@156:4@27:2]

"mmult_hw<float, 32>.exit.i.preheader":           ; preds = %7
  br label %"mmult_hw<float, 32>.exit.i", !dbg !4478 ; [debug line = 159:15@27:2]

; <label>:8                                       ; preds = %7
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([3 x i8]* @.str9, i32 0, i32 0)) nounwind, !dbg !4480 ; [debug line = 54:3@156:4@27:2]
  %rbegin.i.i = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([3 x i8]* @.str9, i32 0, i32 0)) nounwind, !dbg !4480 ; [#uses=1 type=i32] [debug line = 54:3@156:4@27:2]
  br label %9, !dbg !4482                         ; [debug line = 54:21@156:4@27:2]

; <label>:9                                       ; preds = %13, %8
  %ib.0.i.i = phi i32 [ 0, %8 ], [ %ib, %13 ]     ; [#uses=4 type=i32]
  %exitcond1.i.i = icmp eq i32 %ib.0.i.i, 32, !dbg !4482 ; [#uses=1 type=i1] [debug line = 54:21@156:4@27:2]
  br i1 %exitcond1.i.i, label %14, label %10, !dbg !4482 ; [debug line = 54:21@156:4@27:2]

; <label>:10                                      ; preds = %9
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([3 x i8]* @.str10, i32 0, i32 0)) nounwind, !dbg !4484 ; [debug line = 55:4@156:4@27:2]
  %rbegin3.i.i = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([3 x i8]* @.str10, i32 0, i32 0)) nounwind, !dbg !4484 ; [#uses=1 type=i32] [debug line = 55:4@156:4@27:2]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !4486 ; [debug line = 56:1@156:4@27:2]
  br label %11, !dbg !4487                        ; [debug line = 58:22@156:4@27:2]

; <label>:11                                      ; preds = %12, %10
  %sum.0.i.i = phi float [ 0.000000e+00, %10 ], [ %sum, %12 ] ; [#uses=2 type=float]
  %id.0.i.i = phi i32 [ 0, %10 ], [ %id, %12 ]    ; [#uses=4 type=i32]
  %exitcond.i.i = icmp eq i32 %id.0.i.i, 32, !dbg !4487 ; [#uses=1 type=i1] [debug line = 58:22@156:4@27:2]
  br i1 %exitcond.i.i, label %13, label %12, !dbg !4487 ; [debug line = 58:22@156:4@27:2]

; <label>:12                                      ; preds = %11
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([3 x i8]* @.str11, i32 0, i32 0)) nounwind, !dbg !4489 ; [debug line = 60:5@156:4@27:2]
  %rbegin5.i.i = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([3 x i8]* @.str11, i32 0, i32 0)) nounwind, !dbg !4489 ; [#uses=1 type=i32] [debug line = 60:5@156:4@27:2]
  %a.addr.1 = getelementptr inbounds [32 x [32 x float]]* %a, i32 0, i32 %ia.0.i.i, i32 %id.0.i.i, !dbg !4489 ; [#uses=1 type=float*] [debug line = 60:5@156:4@27:2]
  %a.load = load float* %a.addr.1, align 4, !dbg !4489 ; [#uses=2 type=float] [debug line = 60:5@156:4@27:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float %a.load) nounwind
  %b.addr.1 = getelementptr inbounds [32 x [32 x float]]* %b, i32 0, i32 %id.0.i.i, i32 %ib.0.i.i, !dbg !4489 ; [#uses=1 type=float*] [debug line = 60:5@156:4@27:2]
  %b.load = load float* %b.addr.1, align 4, !dbg !4489 ; [#uses=2 type=float] [debug line = 60:5@156:4@27:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float %b.load) nounwind
  %tmp.15 = fmul float %a.load, %b.load, !dbg !4489 ; [#uses=1 type=float] [debug line = 60:5@156:4@27:2]
  %sum = fadd float %sum.0.i.i, %tmp.15, !dbg !4489 ; [#uses=1 type=float] [debug line = 60:5@156:4@27:2]
  call void @llvm.dbg.value(metadata !{float %sum}, i64 0, metadata !4491) nounwind, !dbg !4489 ; [debug line = 60:5@156:4@27:2] [debug variable = sum]
  %rend6.i.i = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([3 x i8]* @.str11, i32 0, i32 0), i32 %rbegin5.i.i) nounwind, !dbg !4492 ; [#uses=0 type=i32] [debug line = 60:32@156:4@27:2]
  %id = add nsw i32 %id.0.i.i, 1, !dbg !4493      ; [#uses=1 type=i32] [debug line = 58:34@156:4@27:2]
  call void @llvm.dbg.value(metadata !{i32 %id}, i64 0, metadata !4494) nounwind, !dbg !4493 ; [debug line = 58:34@156:4@27:2] [debug variable = id]
  br label %11, !dbg !4493                        ; [debug line = 58:34@156:4@27:2]

; <label>:13                                      ; preds = %11
  %sum.0.i.i.lcssa = phi float [ %sum.0.i.i, %11 ] ; [#uses=1 type=float]
  %out.addr = getelementptr inbounds [32 x [32 x float]]* %out, i32 0, i32 %ia.0.i.i, i32 %ib.0.i.i, !dbg !4495 ; [#uses=1 type=float*] [debug line = 61:4@156:4@27:2]
  store float %sum.0.i.i.lcssa, float* %out.addr, align 4, !dbg !4495 ; [debug line = 61:4@156:4@27:2]
  %rend4.i.i = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([3 x i8]* @.str10, i32 0, i32 0), i32 %rbegin3.i.i) nounwind, !dbg !4496 ; [#uses=0 type=i32] [debug line = 62:3@156:4@27:2]
  %ib = add nsw i32 %ib.0.i.i, 1, !dbg !4497      ; [#uses=1 type=i32] [debug line = 54:33@156:4@27:2]
  call void @llvm.dbg.value(metadata !{i32 %ib}, i64 0, metadata !4498) nounwind, !dbg !4497 ; [debug line = 54:33@156:4@27:2] [debug variable = ib]
  br label %9, !dbg !4497                         ; [debug line = 54:33@156:4@27:2]

; <label>:14                                      ; preds = %9
  %rend.i.i = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([3 x i8]* @.str9, i32 0, i32 0), i32 %rbegin.i.i) nounwind, !dbg !4499 ; [#uses=0 type=i32] [debug line = 62:3@156:4@27:2]
  %ia = add nsw i32 %ia.0.i.i, 1, !dbg !4500      ; [#uses=1 type=i32] [debug line = 51:32@156:4@27:2]
  call void @llvm.dbg.value(metadata !{i32 %ia}, i64 0, metadata !4501) nounwind, !dbg !4500 ; [debug line = 51:32@156:4@27:2] [debug variable = ia]
  br label %7, !dbg !4500                         ; [debug line = 51:32@156:4@27:2]

"mmult_hw<float, 32>.exit.i":                     ; preds = %16, %"mmult_hw<float, 32>.exit.i.preheader"
  %i4.0.i = phi i32 [ %i.2, %16 ], [ 0, %"mmult_hw<float, 32>.exit.i.preheader" ] ; [#uses=4 type=i32]
  %exitcond1.i = icmp eq i32 %i4.0.i, 32, !dbg !4478 ; [#uses=1 type=i1] [debug line = 159:15@27:2]
  br i1 %exitcond1.i, label %"wrapped_mmult_hw<float, 32, 1024, 4, 5, 5>.exit", label %.preheader.preheader.i, !dbg !4478 ; [debug line = 159:15@27:2]

.preheader.preheader.i:                           ; preds = %"mmult_hw<float, 32>.exit.i"
  %tmp.9 = shl nsw i32 %i4.0.i, 5, !dbg !4502     ; [#uses=1 type=i32] [debug line = 163:17@27:2]
  br label %.preheader.i, !dbg !4505              ; [debug line = 160:16@27:2]

.preheader.i:                                     ; preds = %15, %.preheader.preheader.i
  %j5.0.i = phi i32 [ %j.2, %15 ], [ 0, %.preheader.preheader.i ] ; [#uses=4 type=i32]
  %exitcond.i = icmp eq i32 %j5.0.i, 32, !dbg !4505 ; [#uses=1 type=i1] [debug line = 160:16@27:2]
  br i1 %exitcond.i, label %16, label %15, !dbg !4505 ; [debug line = 160:16@27:2]

; <label>:15                                      ; preds = %.preheader.i
  %rbegin.i = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str7, i32 0, i32 0)) nounwind, !dbg !4506 ; [#uses=1 type=i32] [debug line = 161:6@27:2]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !4507 ; [debug line = 162:1@27:2]
  %k.2 = add nsw i32 %j5.0.i, %tmp.9, !dbg !4502  ; [#uses=8 type=i32] [debug line = 163:17@27:2]
  call void @llvm.dbg.value(metadata !{i32 %k.2}, i64 0, metadata !4508) nounwind, !dbg !4502 ; [debug line = 163:17@27:2] [debug variable = k]
  %v.assign = getelementptr inbounds [32 x [32 x float]]* %out, i32 0, i32 %i4.0.i, i32 %j5.0.i, !dbg !4509 ; [#uses=1 type=float*] [debug line = 164:22@27:2]
  %last.assign = icmp eq i32 %k.2, 1023, !dbg !4509 ; [#uses=2 type=i1] [debug line = 164:22@27:2]
  call void @llvm.dbg.value(metadata !{float* %v.assign}, i64 0, metadata !4510) nounwind, !dbg !4511 ; [debug line = 95:97@164:22@27:2] [debug variable = v]
  call void @llvm.dbg.value(metadata !{i1 %last.assign}, i64 0, metadata !4512) nounwind, !dbg !4513 ; [debug line = 95:105@164:22@27:2] [debug variable = last]
  %v.assign.load = load float* %v.assign, align 4, !dbg !4514 ; [#uses=1 type=float] [debug line = 106:2@164:22@27:2]
  %val.assign = bitcast float %v.assign.load to i32, !dbg !4514 ; [#uses=2 type=i32] [debug line = 106:2@164:22@27:2]
  call void @llvm.dbg.value(metadata !{i32 %val.assign}, i64 0, metadata !4516) nounwind, !dbg !4518 ; [debug line = 250:55@107:2@164:22@27:2] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i32 %val.assign}, i64 0, metadata !4519) nounwind, !dbg !4521 ; [debug line = 250:55@250:77@107:2@164:22@27:2] [debug variable = val]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %val.assign) nounwind
  %OUTPUT_STREAM.addr = getelementptr inbounds %struct.ap_axiu.40* %OUTPUT_STREAM, i32 %k.2, i32 0, i32 0, i32 0, i32 0, !dbg !4522 ; [#uses=1 type=i32*] [debug line = 277:10@100:10@164:22@27:2]
  store i32 %val.assign, i32* %OUTPUT_STREAM.addr, align 4, !dbg !4522 ; [debug line = 277:10@100:10@164:22@27:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i4 -1) nounwind
  %OUTPUT_STREAM.addr.1 = getelementptr inbounds %struct.ap_axiu.40* %OUTPUT_STREAM, i32 %k.2, i32 1, i32 0, i32 0, i32 0, !dbg !4526 ; [#uses=1 type=i4*] [debug line = 277:10@100:10@164:22@27:2]
  store i4 -1, i4* %OUTPUT_STREAM.addr.1, align 1, !dbg !4526 ; [debug line = 277:10@100:10@164:22@27:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i4 -1) nounwind
  %OUTPUT_STREAM.addr.2 = getelementptr inbounds %struct.ap_axiu.40* %OUTPUT_STREAM, i32 %k.2, i32 2, i32 0, i32 0, i32 0, !dbg !4526 ; [#uses=1 type=i4*] [debug line = 277:10@100:10@164:22@27:2]
  store i4 -1, i4* %OUTPUT_STREAM.addr.2, align 1, !dbg !4526 ; [debug line = 277:10@100:10@164:22@27:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i4 0) nounwind
  %OUTPUT_STREAM.addr.3 = getelementptr inbounds %struct.ap_axiu.40* %OUTPUT_STREAM, i32 %k.2, i32 3, i32 0, i32 0, i32 0, !dbg !4526 ; [#uses=1 type=i4*] [debug line = 277:10@100:10@164:22@27:2]
  store i4 0, i4* %OUTPUT_STREAM.addr.3, align 1, !dbg !4526 ; [debug line = 277:10@100:10@164:22@27:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %last.assign) nounwind
  %OUTPUT_STREAM.addr.4 = getelementptr inbounds %struct.ap_axiu.40* %OUTPUT_STREAM, i32 %k.2, i32 4, i32 0, i32 0, i32 0, !dbg !4528 ; [#uses=1 type=i1*] [debug line = 277:10@100:10@164:22@27:2]
  store i1 %last.assign, i1* %OUTPUT_STREAM.addr.4, align 1, !dbg !4528 ; [debug line = 277:10@100:10@164:22@27:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i5 0) nounwind
  %OUTPUT_STREAM.addr.5 = getelementptr inbounds %struct.ap_axiu.40* %OUTPUT_STREAM, i32 %k.2, i32 5, i32 0, i32 0, i32 0, !dbg !4530 ; [#uses=1 type=i5*] [debug line = 277:10@100:10@164:22@27:2]
  store i5 0, i5* %OUTPUT_STREAM.addr.5, align 1, !dbg !4530 ; [debug line = 277:10@100:10@164:22@27:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i5 0) nounwind
  %OUTPUT_STREAM.addr.6 = getelementptr inbounds %struct.ap_axiu.40* %OUTPUT_STREAM, i32 %k.2, i32 6, i32 0, i32 0, i32 0, !dbg !4530 ; [#uses=1 type=i5*] [debug line = 277:10@100:10@164:22@27:2]
  store i5 0, i5* %OUTPUT_STREAM.addr.6, align 1, !dbg !4530 ; [debug line = 277:10@100:10@164:22@27:2]
  %rend.i = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str7, i32 0, i32 0), i32 %rbegin.i) nounwind, !dbg !4532 ; [#uses=0 type=i32] [debug line = 165:5@27:2]
  %j.2 = add nsw i32 %j5.0.i, 1, !dbg !4533       ; [#uses=1 type=i32] [debug line = 160:25@27:2]
  call void @llvm.dbg.value(metadata !{i32 %j.2}, i64 0, metadata !4534) nounwind, !dbg !4533 ; [debug line = 160:25@27:2] [debug variable = j]
  br label %.preheader.i, !dbg !4533              ; [debug line = 160:25@27:2]

; <label>:16                                      ; preds = %.preheader.i
  %i.2 = add nsw i32 %i4.0.i, 1, !dbg !4535       ; [#uses=1 type=i32] [debug line = 159:24@27:2]
  call void @llvm.dbg.value(metadata !{i32 %i.2}, i64 0, metadata !4536) nounwind, !dbg !4535 ; [debug line = 159:24@27:2] [debug variable = i]
  br label %"mmult_hw<float, 32>.exit.i", !dbg !4535 ; [debug line = 159:24@27:2]

"wrapped_mmult_hw<float, 32, 1024, 4, 5, 5>.exit": ; preds = %"mmult_hw<float, 32>.exit.i"
  ret void, !dbg !4537                            ; [debug line = 29:2]
}
...
!4351 = metadata !{void (%struct.ap_axiu.40*, %struct.ap_axiu.40*)* @HLS_accel, metadata !4352, metadata !4353, metadata !4354, metadata !4355, metadata !4356, metadata !4350}
...
!4392 = metadata !{i32 786689, metadata !884, metadata !"INPUT_STREAM", metadata !876, i32 16777236, metadata !887, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4393 = metadata !{i32 20, i32 25, metadata !884, null}
!4394 = metadata !{i32 786689, metadata !884, metadata !"OUTPUT_STREAM", metadata !876, i32 33554452, metadata !887, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4395 = metadata !{i32 20, i32 55, metadata !884, null}
!4396 = metadata !{i32 21, i32 2, metadata !4397, null}
!4397 = metadata !{i32 786443, metadata !884, i32 21, i32 1, metadata !876, i32 1} ; [ DW_TAG_lexical_block ]
!4398 = metadata !{i32 21, i32 45, metadata !4397, null}
!4399 = metadata !{i32 23, i32 1, metadata !4397, null}
!4400 = metadata !{i32 24, i32 1, metadata !4397, null}
!4401 = metadata !{i32 25, i32 1, metadata !4397, null}
!4402 = metadata !{i32 786689, metadata !2508, metadata !"in_stream", metadata !2509, i32 16777340, metadata !887, i32 0, metadata !4403} ; [ DW_TAG_arg_variable ]
!4403 = metadata !{i32 27, i32 2, metadata !4397, null}
!4404 = metadata !{i32 124, i32 10, metadata !2508, metadata !4403}
!4405 = metadata !{i32 786689, metadata !2508, metadata !"out_stream", metadata !2509, i32 33554557, metadata !887, i32 0, metadata !4403} ; [ DW_TAG_arg_variable ]
!4406 = metadata !{i32 125, i32 10, metadata !2508, metadata !4403}
!4407 = metadata !{i32 786688, metadata !4408, metadata !"a", metadata !2509, i32 130, metadata !4409, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4408 = metadata !{i32 786443, metadata !2508, i32 126, i32 1, metadata !2509, i32 2} ; [ DW_TAG_lexical_block ]
!4409 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 32768, i64 32, i32 0, i32 0, metadata !881, metadata !4410, i32 0, i32 0} ; [ DW_TAG_array_type ]
!4410 = metadata !{metadata !883, metadata !883}
!4411 = metadata !{i32 130, i32 4, metadata !4408, metadata !4403}
!4412 = metadata !{i32 786688, metadata !4408, metadata !"b", metadata !2509, i32 131, metadata !4409, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4413 = metadata !{i32 131, i32 4, metadata !4408, metadata !4403}
!4414 = metadata !{i32 786688, metadata !4408, metadata !"out", metadata !2509, i32 132, metadata !4409, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4415 = metadata !{i32 132, i32 4, metadata !4408, metadata !4403}
!4416 = metadata !{i32 137, i32 13, metadata !4417, metadata !4403}
!4417 = metadata !{i32 786443, metadata !4408, i32 137, i32 2, metadata !2509, i32 3} ; [ DW_TAG_lexical_block ]
!4418 = metadata !{i32 147, i32 14, metadata !4419, metadata !4403}
!4419 = metadata !{i32 786443, metadata !4408, i32 147, i32 3, metadata !2509, i32 6} ; [ DW_TAG_lexical_block ]
!4420 = metadata !{i32 141, i32 17, metadata !4421, metadata !4403}
!4421 = metadata !{i32 786443, metadata !4422, i32 139, i32 3, metadata !2509, i32 5} ; [ DW_TAG_lexical_block ]
!4422 = metadata !{i32 786443, metadata !4417, i32 138, i32 3, metadata !2509, i32 4} ; [ DW_TAG_lexical_block ]
!4423 = metadata !{i32 138, i32 14, metadata !4422, metadata !4403}
!4424 = metadata !{i32 139, i32 4, metadata !4421, metadata !4403}
!4425 = metadata !{i32 140, i32 1, metadata !4421, metadata !4403}
!4426 = metadata !{i32 786688, metadata !4421, metadata !"k", metadata !2509, i32 141, metadata !56, i32 0, metadata !4403} ; [ DW_TAG_auto_variable ]
!4427 = metadata !{i32 1653, i32 70, metadata !4428, metadata !4429}
!4428 = metadata !{i32 786443, metadata !2562, i32 1653, i32 68, metadata !865, i32 36} ; [ DW_TAG_lexical_block ]
!4429 = metadata !{i32 82, i32 19, metadata !4430, metadata !4431}
!4430 = metadata !{i32 786443, metadata !2559, i32 73, i32 1, metadata !2509, i32 35} ; [ DW_TAG_lexical_block ]
!4431 = metadata !{i32 142, i32 14, metadata !4421, metadata !4403}
!4432 = metadata !{i32 83, i32 24, metadata !4430, metadata !4431}
!4433 = metadata !{i32 786688, metadata !4430, metadata !"ret", metadata !2509, i32 83, metadata !881, i32 0, metadata !4431} ; [ DW_TAG_auto_variable ]
!4434 = metadata !{i32 85, i32 43, metadata !4430, metadata !4431}
!4435 = metadata !{i32 86, i32 43, metadata !4430, metadata !4431}
!4436 = metadata !{i32 87, i32 35, metadata !4430, metadata !4431}
!4437 = metadata !{i32 88, i32 35, metadata !4430, metadata !4431}
!4438 = metadata !{i32 89, i32 32, metadata !4430, metadata !4431}
!4439 = metadata !{i32 90, i32 36, metadata !4430, metadata !4431}
!4440 = metadata !{i32 144, i32 3, metadata !4421, metadata !4403}
!4441 = metadata !{i32 138, i32 23, metadata !4422, metadata !4403}
!4442 = metadata !{i32 786688, metadata !4422, metadata !"j", metadata !2509, i32 138, metadata !56, i32 0, metadata !4403} ; [ DW_TAG_auto_variable ]
!4443 = metadata !{i32 137, i32 22, metadata !4417, metadata !4403}
!4444 = metadata !{i32 786688, metadata !4417, metadata !"i", metadata !2509, i32 137, metadata !56, i32 0, metadata !4403} ; [ DW_TAG_auto_variable ]
!4445 = metadata !{i32 151, i32 22, metadata !4446, metadata !4403}
!4446 = metadata !{i32 786443, metadata !4447, i32 149, i32 4, metadata !2509, i32 8} ; [ DW_TAG_lexical_block ]
!4447 = metadata !{i32 786443, metadata !4419, i32 148, i32 4, metadata !2509, i32 7} ; [ DW_TAG_lexical_block ]
!4448 = metadata !{i32 148, i32 15, metadata !4447, metadata !4403}
!4449 = metadata !{i32 149, i32 5, metadata !4446, metadata !4403}
!4450 = metadata !{i32 150, i32 1, metadata !4446, metadata !4403}
!4451 = metadata !{i32 786688, metadata !4446, metadata !"k", metadata !2509, i32 151, metadata !56, i32 0, metadata !4403} ; [ DW_TAG_auto_variable ]
!4452 = metadata !{i32 1653, i32 70, metadata !4428, metadata !4453}
!4453 = metadata !{i32 82, i32 19, metadata !4430, metadata !4454}
!4454 = metadata !{i32 152, i32 15, metadata !4446, metadata !4403}
!4455 = metadata !{i32 83, i32 24, metadata !4430, metadata !4454}
!4456 = metadata !{i32 786688, metadata !4430, metadata !"ret", metadata !2509, i32 83, metadata !881, i32 0, metadata !4454} ; [ DW_TAG_auto_variable ]
!4457 = metadata !{i32 85, i32 43, metadata !4430, metadata !4454}
!4458 = metadata !{i32 86, i32 43, metadata !4430, metadata !4454}
!4459 = metadata !{i32 87, i32 35, metadata !4430, metadata !4454}
!4460 = metadata !{i32 88, i32 35, metadata !4430, metadata !4454}
!4461 = metadata !{i32 89, i32 32, metadata !4430, metadata !4454}
!4462 = metadata !{i32 90, i32 36, metadata !4430, metadata !4454}
!4463 = metadata !{i32 153, i32 4, metadata !4446, metadata !4403}
!4464 = metadata !{i32 148, i32 24, metadata !4447, metadata !4403}
!4465 = metadata !{i32 786688, metadata !4447, metadata !"j", metadata !2509, i32 148, metadata !56, i32 0, metadata !4403} ; [ DW_TAG_auto_variable ]
!4466 = metadata !{i32 147, i32 23, metadata !4419, metadata !4403}
!4467 = metadata !{i32 786688, metadata !4419, metadata !"i", metadata !2509, i32 147, metadata !56, i32 0, metadata !4403} ; [ DW_TAG_auto_variable ]
!4468 = metadata !{i32 156, i32 4, metadata !4408, metadata !4403}
!4469 = metadata !{i32 786689, metadata !2563, metadata !"a", metadata !2509, i32 16777260, metadata !879, i32 0, metadata !4468} ; [ DW_TAG_arg_variable ]
!4470 = metadata !{i32 44, i32 17, metadata !2563, metadata !4468}
!4471 = metadata !{i32 786689, metadata !2563, metadata !"b", metadata !2509, i32 33554476, metadata !879, i32 0, metadata !4468} ; [ DW_TAG_arg_variable ]
!4472 = metadata !{i32 44, i32 32, metadata !2563, metadata !4468}
!4473 = metadata !{i32 47, i32 1, metadata !4474, metadata !4468}
!4474 = metadata !{i32 786443, metadata !2563, i32 45, i32 1, metadata !2509, i32 37} ; [ DW_TAG_lexical_block ]
!4475 = metadata !{i32 48, i32 1, metadata !4474, metadata !4468}
!4476 = metadata !{i32 51, i32 20, metadata !4477, metadata !4468}
!4477 = metadata !{i32 786443, metadata !4474, i32 51, i32 5, metadata !2509, i32 38} ; [ DW_TAG_lexical_block ]
!4478 = metadata !{i32 159, i32 15, metadata !4479, metadata !4403}
!4479 = metadata !{i32 786443, metadata !4408, i32 159, i32 4, metadata !2509, i32 9} ; [ DW_TAG_lexical_block ]
!4480 = metadata !{i32 54, i32 3, metadata !4481, metadata !4468}
!4481 = metadata !{i32 786443, metadata !4477, i32 54, i32 3, metadata !2509, i32 39} ; [ DW_TAG_lexical_block ]
!4482 = metadata !{i32 54, i32 21, metadata !4483, metadata !4468}
!4483 = metadata !{i32 786443, metadata !4481, i32 54, i32 6, metadata !2509, i32 40} ; [ DW_TAG_lexical_block ]
!4484 = metadata !{i32 55, i32 4, metadata !4485, metadata !4468}
!4485 = metadata !{i32 786443, metadata !4483, i32 55, i32 3, metadata !2509, i32 41} ; [ DW_TAG_lexical_block ]
!4486 = metadata !{i32 56, i32 1, metadata !4485, metadata !4468}
!4487 = metadata !{i32 58, i32 22, metadata !4488, metadata !4468}
!4488 = metadata !{i32 786443, metadata !4485, i32 58, i32 7, metadata !2509, i32 42} ; [ DW_TAG_lexical_block ]
!4489 = metadata !{i32 60, i32 5, metadata !4490, metadata !4468}
!4490 = metadata !{i32 786443, metadata !4488, i32 60, i32 5, metadata !2509, i32 43} ; [ DW_TAG_lexical_block ]
!4491 = metadata !{i32 786688, metadata !4485, metadata !"sum", metadata !2509, i32 57, metadata !881, i32 0, metadata !4468} ; [ DW_TAG_auto_variable ]
!4492 = metadata !{i32 60, i32 32, metadata !4490, metadata !4468}
!4493 = metadata !{i32 58, i32 34, metadata !4488, metadata !4468}
!4494 = metadata !{i32 786688, metadata !4488, metadata !"id", metadata !2509, i32 58, metadata !56, i32 0, metadata !4468} ; [ DW_TAG_auto_variable ]
!4495 = metadata !{i32 61, i32 4, metadata !4485, metadata !4468}
!4496 = metadata !{i32 62, i32 3, metadata !4485, metadata !4468}
!4497 = metadata !{i32 54, i32 33, metadata !4483, metadata !4468}
!4498 = metadata !{i32 786688, metadata !4483, metadata !"ib", metadata !2509, i32 54, metadata !56, i32 0, metadata !4468} ; [ DW_TAG_auto_variable ]
!4499 = metadata !{i32 62, i32 3, metadata !4483, metadata !4468}
!4500 = metadata !{i32 51, i32 32, metadata !4477, metadata !4468}
!4501 = metadata !{i32 786688, metadata !4477, metadata !"ia", metadata !2509, i32 51, metadata !56, i32 0, metadata !4468} ; [ DW_TAG_auto_variable ]
!4502 = metadata !{i32 163, i32 17, metadata !4503, metadata !4403}
!4503 = metadata !{i32 786443, metadata !4504, i32 161, i32 5, metadata !2509, i32 11} ; [ DW_TAG_lexical_block ]
!4504 = metadata !{i32 786443, metadata !4479, i32 160, i32 5, metadata !2509, i32 10} ; [ DW_TAG_lexical_block ]
!4505 = metadata !{i32 160, i32 16, metadata !4504, metadata !4403}
!4506 = metadata !{i32 161, i32 6, metadata !4503, metadata !4403}
!4507 = metadata !{i32 162, i32 1, metadata !4503, metadata !4403}
!4508 = metadata !{i32 786688, metadata !4503, metadata !"k", metadata !2509, i32 163, metadata !56, i32 0, metadata !4403} ; [ DW_TAG_auto_variable ]
!4509 = metadata !{i32 164, i32 22, metadata !4503, metadata !4403}
!4510 = metadata !{i32 786689, metadata !2514, metadata !"v", metadata !2509, i32 16777311, metadata !2517, i32 0, metadata !4509} ; [ DW_TAG_arg_variable ]
!4511 = metadata !{i32 95, i32 97, metadata !2514, metadata !4509}
!4512 = metadata !{i32 786689, metadata !2514, metadata !"last", metadata !2509, i32 33554527, metadata !212, i32 0, metadata !4509} ; [ DW_TAG_arg_variable ]
!4513 = metadata !{i32 95, i32 105, metadata !2514, metadata !4509}
!4514 = metadata !{i32 106, i32 2, metadata !4515, metadata !4509}
!4515 = metadata !{i32 786443, metadata !2514, i32 96, i32 1, metadata !2509, i32 12} ; [ DW_TAG_lexical_block ]
!4516 = metadata !{i32 786689, metadata !2535, metadata !"val", metadata !894, i32 33554682, metadata !56, i32 0, metadata !4517} ; [ DW_TAG_arg_variable ]
!4517 = metadata !{i32 107, i32 2, metadata !4515, metadata !4509}
!4518 = metadata !{i32 250, i32 55, metadata !2535, metadata !4517}
!4519 = metadata !{i32 786689, metadata !2536, metadata !"val", metadata !894, i32 33554682, metadata !56, i32 0, metadata !4520} ; [ DW_TAG_arg_variable ]
!4520 = metadata !{i32 250, i32 77, metadata !2535, metadata !4517}
!4521 = metadata !{i32 250, i32 55, metadata !2536, metadata !4520}
!4522 = metadata !{i32 277, i32 10, metadata !4523, metadata !4524}
!4523 = metadata !{i32 786443, metadata !2539, i32 276, i32 92, metadata !894, i32 28} ; [ DW_TAG_lexical_block ]
!4524 = metadata !{i32 100, i32 10, metadata !4525, metadata !4509}
!4525 = metadata !{i32 786443, metadata !2553, i32 100, i32 10, metadata !890, i32 34} ; [ DW_TAG_lexical_block ]
!4526 = metadata !{i32 277, i32 10, metadata !4527, metadata !4524}
!4527 = metadata !{i32 786443, metadata !2534, i32 276, i32 92, metadata !894, i32 24} ; [ DW_TAG_lexical_block ]
!4528 = metadata !{i32 277, i32 10, metadata !4529, metadata !4524}
!4529 = metadata !{i32 786443, metadata !2529, i32 276, i32 92, metadata !894, i32 20} ; [ DW_TAG_lexical_block ]
!4530 = metadata !{i32 277, i32 10, metadata !4531, metadata !4524}
!4531 = metadata !{i32 786443, metadata !2524, i32 276, i32 92, metadata !894, i32 16} ; [ DW_TAG_lexical_block ]
!4532 = metadata !{i32 165, i32 5, metadata !4503, metadata !4403}
!4533 = metadata !{i32 160, i32 25, metadata !4504, metadata !4403}
!4534 = metadata !{i32 786688, metadata !4504, metadata !"j", metadata !2509, i32 160, metadata !56, i32 0, metadata !4403} ; [ DW_TAG_auto_variable ]
!4535 = metadata !{i32 159, i32 24, metadata !4479, metadata !4403}
!4536 = metadata !{i32 786688, metadata !4479, metadata !"i", metadata !2509, i32 159, metadata !56, i32 0, metadata !4403} ; [ DW_TAG_auto_variable ]
!4537 = metadata !{i32 29, i32 2, metadata !4397, null}
